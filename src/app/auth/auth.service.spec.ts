...
describe('AuthService', () => {
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      ...
      providers: [AuthService, { provide: LOCAL_STORAGE, useValue: localStorage }]
    });
  ...
  it('should log in and store user credentials', () => {
    ...
    expect(storage.getItem(environment.tokenValidityEndKey)).toBe(
      (loginResponse.created + loginResponse.ttl * 1000).toString()
    );
